...
func (f ezmer) AddIndex(table string, columns interface{}, options Options) error {
...
func (f ezmer) DropIndex(table, name string) {
...
func (f ezmer) RenameIndex(table, old, new string) {
