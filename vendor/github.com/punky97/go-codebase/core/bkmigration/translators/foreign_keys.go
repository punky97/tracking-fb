...
func (f ezmer) AddForeignKey(table string, column string, refs interface{}, options Options) error {
...
func (f ezmer) DropForeignKey(table string, fk string, options Options) {
